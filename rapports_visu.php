          ...
          <nav class="navbar navbar-expand-lg navbar-dark">
              ...
              <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 padding-top-0">
                ...
                <div class="container justify-content-center">
                  <iframe src="<?php if(isset($_SESSION['currentRapport']) and $_SESSION['currentRapport']!="") echo "rapports/".$_SESSION['currentRapport'];?>" width="900" height="800" align="middle"></iframe>
                </div>
