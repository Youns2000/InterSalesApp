...
$_SESSION['currentPage'] = "bon_de_commande_visu";
  ...
  <?php include("header.php"); ?>
              ...
              <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 padding-top-0">
                ...
                <div class="container justify-content-center">
                  <iframe src="<?php if(isset($_SESSION['currentProforma']) and $_SESSION['currentProforma']!="") echo "bons/".$_SESSION['currentProforma'].".pdf";?>" width="900" height="800" align="middle"></iframe>
                </div>
